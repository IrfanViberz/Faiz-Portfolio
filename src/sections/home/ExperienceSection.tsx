          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10">
              ...
              <div className="md:col-span-4 pt-1 border-b md:border-b-0 md:border-r border-[var(--border-color)] pb-4 md:pb-0 md:pr-6">
                <div className="inline-block px-2.5 py-1 rounded text-xs font-mono font-medium bg-[var(--bg-tertiary)] text-cyan-400 border border-cyan-500/20 mb-2 transition-colors duration-500">
                  {item.period}
                </div>
                          ...
                          >
                            ...
                            <div className="p-3 bg-[var(--bg-secondary)] border-b border-[var(--border-color)] flex items-center justify-between">
                              ...
                              <button
                                ...
                                title="Expand image"
                                className="p-1.5 rounded text-[var(--text-secondary)] hover:text-white bg-[var(--bg-tertiary)] hover:bg-cyan-600/80 border border-[var(--border-color)] transition-all duration-200 cursor-pointer"
                              >
                            ...
                            <div
                              ...
                              className="relative w-full h-80 sm:h-96 p-2 bg-black/50 cursor-pointer overflow-hidden flex items-center justify-center group"
                            >
                              <Image
                                src={img.url}
                                alt={img.label}
                              ...
                              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center pointer-events-none">
                                <div className="px-3 py-1.5 rounded-full bg-black/80 border border-cyan-500/50 text-white text-xs font-mono flex items-center gap-1.5 shadow-lg">
                      ...
                      <div className="relative w-full h-64 sm:h-80 rounded-lg overflow-hidden border border-[var(--border-color)] mb-5 group bg-[var(--bg-tertiary)]">
                        ...
                        >
                          ...
                          <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <div className="p-2 rounded bg-black/80 border border-cyan-500/40 text-white text-xs font-mono flex items-center">
                              <Maximize2 className="w-3.5 h-3.5 text-cyan-400" />
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="mt-6 pt-5 border-t border-[var(--border-color)]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                          {proj.docs.map((doc, dIdx) => (
                            <div
                              key={dIdx}
                              className="p-4 rounded-lg border border-zinc-300 dark:border-zinc-600/80 bg-zinc-100 dark:bg-zinc-800/80 shadow-sm flex flex-col justify-between hover:border-cyan-500/50 dark:hover:border-cyan-400/60 hover:shadow-md transition-all duration-300 group"
                            >
                              <div>
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-7 h-7 rounded bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 flex items-center justify-center text-cyan-500 dark:text-cyan-400 shadow-xs">
                                    {dIdx === 0 ? (
                              ...
                              <div className="flex items-center gap-2 pt-3 border-t border-zinc-200 dark:border-zinc-700/80">
                                <a
                                  href={doc.viewUrl}
                                  target="_blank"
