...
export default function ResumeSection() {
  ...
  const item = t.raw('item') as { lang: string; badge: string; title: string; description: string };
    ...
    <Section id="resume" title={t('title')}>
      <div className="flex justify-center relative z-10">
        <motion.div
          ...
          className="w-full border border-[var(--border-color)] rounded-lg p-6 sm:p-7 bg-[var(--bg-secondary)] transition-all duration-300 hover:border-[var(--text-tertiary)] flex flex-col justify-between"
        >
          <div>
            <div className="flex items-center justify-between gap-3 mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Badge highlight>{item.badge}</Badge>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-[var(--border-color)]">
            ...
            <a
              href={resumeUrl.viewUrl}
              download={resumeUrl.downloadName}
