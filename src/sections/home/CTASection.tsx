    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center border-t border-[var(--border-color)] pt-32 transition-colors duration-500">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/contact"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-medium rounded-md bg-blue-600 hover:bg-blue-500 text-white shadow-sm transition-all duration-300"
          >
