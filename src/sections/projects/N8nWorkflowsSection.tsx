...
import { Download, Code, X, Check, Copy, Workflow, Cpu, Clock, Layers, Maximize2 } from 'lucide-react';
...
export default function N8nWorkflowsSection() {
  ...
  return (
    <Section title="02. n8n Automation Workflows">
            ...
            <div className="p-6 md:w-1/2 flex flex-col justify-between">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-[var(--border-color)]">
                {workflow.image && (
                  <button
                    onClick={() => setActiveImage({ title: workflow.title, src: workflow.image! })}
                    className="inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium rounded border border-[var(--border-color)] bg-[var(--bg-tertiary)] text-[var(--text-primary)] hover:border-[var(--text-tertiary)] transition-colors duration-300"
